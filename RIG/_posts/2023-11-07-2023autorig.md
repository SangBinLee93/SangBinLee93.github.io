...
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/24_soft.mp4)  
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/25_soft_L.mp4)  
...
- followTarget - Rotation
  ![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/27_poleArm_rot.mp4)  
...
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/28_BendStiffness.mp4)  
...
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/31_rootFollowWeight0.mp4)  

- rootFollowWeight 10:

The default rotation angle of **L_IkLeg_pv_rot_CTL** follows the "RootX".

![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/32_rootFollowWeight10.mp4)  
...
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/35_ToeBreak.mp4) 
...
![alt]({{ site.url }}{{ site.baseurl }}/assets/images/autorig/36_SmartToes.mp4)  
